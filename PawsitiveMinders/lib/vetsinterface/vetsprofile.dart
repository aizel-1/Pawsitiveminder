...
class Vetsprofile extends StatefulWidget {
  const Vetsprofile({Key? key}) : super(key: key);
...
//update profile screen
  ...
  @override
  State<Vetsprofile> createState() => _VetsprofileState();
}

class _VetsprofileState extends State<Vetsprofile> {
  @override
